...
def interactive_webhook():
    ...
    if callback_id == "work_task":
        ...
        response_data = {
            ...
            "triggerId": trigger_id,
            "replaceOriginal": "false",
            "text": f"[@홍석기C/SGE PM팀](dooray://3570973280734982045/members/3571008351482084031 \"admin\")"  # [@홍석기C/SGE PM팀]
                    f"[@노승한/SGE PM팀](dooray://3570973280734982045/members/3571008626725314977 \"admin\")"  # [@노승한/SGE PM팀]
